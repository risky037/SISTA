...
@section('title', 'Tambah Template Skripsi')

@section('content')
    <div class="flex justify-between items-center mb-4">
        <div>
            <h1 class="text-gray-800 text-xl font-semibold">@yield('title')</h1>
            <p class="text-gray-500 text-sm">Halaman untuk menambahkan template skripsi baru.</p>
        </div>
    ...
    <div class="p-6 bg-white rounded-lg shadow-md">
        ...
        <form action="{{ route('admin.template.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="nama_template" name="nama_template" value="{{ old('nama_template') }}"
            ...
            <div class="mb-4">
                ...
                <textarea id="aturan_format" name="aturan_format" rows="4"
                    class="w-full border rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-green-500">{{ old('aturan_format') }}</textarea>
            </div>

            <div class="mb-6">
                <label for="file" class="block text-sm font-medium text-gray-700">Upload File Template</label>
