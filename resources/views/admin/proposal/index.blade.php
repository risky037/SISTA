                ...
                <tbody>
                    @forelse ($proposals as $p)
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-2 md:px-4 py-2 border break-words max-w-[150px]">{{ $p->mahasiswa->nama }}</td>
                            <td class="px-2 md:px-4 py-2 border break-words max-w-[150px]">{{ $p->dosen->nama }}</td>
