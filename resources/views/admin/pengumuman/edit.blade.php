...
@section('content')
    <div class="flex justify-between items-center mb-4">
        <div>
            ...
            <p class="text-gray-500 text-sm">Halaman untuk memperbarui data pengumuman.</p>
        </div>
    ...
    <div class="p-6 bg-white rounded-lg shadow-md">
        <h2 class="text-xl font-bold mb-4">Edit Data Pengumuman</h2>
        ...
        <form action="{{ route('admin.pengumuman.update', $pengumuman->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <textarea name="informasi" rows="5"
                    ...
                    required>{{ old('informasi', $pengumuman->informasi) }}</textarea>
                @error('informasi')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>

            <div class="p-3 bg-blue-50 border border-blue-200 rounded-md text-sm text-blue-800 flex items-center gap-2">
            ...
            <div>
                <label class="block text-gray-700">Ganti File PDF (Opsional)</label>
