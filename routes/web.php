...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/api/prodi', [ProfileController::class, 'getProdi'])->name('api.prodi');
    Route::get('/api/bidang-keahlian', [ProfileController::class, 'getBidangKeahlian'])->name('api.bidang-keahlian');
